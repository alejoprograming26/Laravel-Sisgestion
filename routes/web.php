...
Route::post('/admin/estudiantes/ppff/create', [App\Http\Controllers\PpffController::class,'store'])->name('admin.estudiantes.ppffs.store')->middleware('auth', 'can:admin.ppffs.store');
...
Route::get('/admin/matriculaciones/buscar_grado/{id}', [App\Http\Controllers\MatriculacionController::class,'buscar_grados'])->name('admin.matriculaciones.buscar_grado')->middleware('auth', 'can:admin.matriculaciones.buscar_grado');
Route::get('/admin/matriculaciones/buscar_paralelos/{id}', [App\Http\Controllers\MatriculacionController::class,'buscar_paralelos'])->name('admin.matriculaciones.buscar_paralelo')->middleware('auth', 'can:admin.matriculaciones.buscar_paralelo');
