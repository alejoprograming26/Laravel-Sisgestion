...
Route::post('/admin/configuracion/create', [App\Http\Controllers\ConfiguracionController::class,'store'])->name('admin.configuracion.create')->middleware('auth');
...
Route::post('/admin/estudiantes/ppff/create', [App\Http\Controllers\PpffController::class,'store'])->name('admin.estudiantes.ppffs.store')->middleware('auth');
...
Route::get('/admin/matriculaciones/buscar_grado/{id}', [App\Http\Controllers\MatriculacionController::class,'buscar_grados'])->name('admin.matriculaciones.buscar_grado')->middleware('auth');
Route::get('/admin/matriculaciones/buscar_paralelos/{id}', [App\Http\Controllers\MatriculacionController::class,'buscar_paralelos'])->name('admin.matriculaciones.buscar_paralelo')->middleware('auth');
...
//Rutas Asignacion Materia docentes
