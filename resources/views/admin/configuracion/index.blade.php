...
@section('content_header')
    <h1 style="font-weight: bold; font-size: 1.5rem">DATOS DEL SISTEMA</h1>
    <hr>
@stop
                ...
                <div class="card-body">
                    <form action="{{ url('/admin/configuracion/create') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <center> <br>
                                        <img id="preview"
                                            src="{{ url($configuracion->logo) }}"style="max-width: 300px; margin-top: 10px;">
                                    </center>
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <select name="divisa" id="" class="form-control" required>
                                                    ...
                                                    @foreach ($divisas as $divisa)
                                                        <option
                                                            value="{{ $divisa['symbol'] }}"{{ old('divisa', $configuracion->divisa ?? '') == $divisa['symbol'] ? 'selected' : '' }}>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <a href="{{ url('/admin') }}" class="btn btn-secondary"><i
                                            class="fas fa-arrow-left">
                                            Cancelar</i>
                                    </a>
                                    <button type="submit" class="btn btn-success"><i class="fas fa-save ml-2"></i>
                                        Guardar</button>
                                </div>
                            </div>
                        </div>
