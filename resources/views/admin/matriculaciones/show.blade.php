...
@section('content_header')
    <h1 style="font-weight: bold; font-size: 1.5rem">Matriculaciones/Datos de Una Matriculación</h1>
    <hr>
@stop
            ...
            <div class="card card-purple">
                ...
                <div class="card-body">
                    <form action="{{ url('admin/matriculaciones/create') }}" method="POST">
                        @csrf
                        <input type="text" name="estudiante_id" id="estudiante_id" value="" hidden required>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" value="{{ $matriculacion->turno->nombre }}" disabled>
                                    </div>
                                    @error('turno_id')
                             ...
                             <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" value="{{ $matriculacion->gestion->nombre }}" disabled>
                                    </div>
                                    @error('gestion_id')
                                        <small style="color:red">{{ $message }}</small>
                                    @enderror
                             ...
                             <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" value="{{ $matriculacion->nivel->nombre }}" disabled>
                                    </div>
                                    @error('nivel_id')
                                        <small style="color:red">{{ $message }}</small>
                                    @enderror
                             ...
                             <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" value="{{ $matriculacion->grado->nombre }}" disabled>
                                    </div>
                                    @error('grados_id')
                                        <small style="color:red">{{ $message }}</small>
                                    @enderror
                             ...
                             <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" value="{{ $matriculacion->paralelo->nombre }}" disabled>
                                    </div>
                                    @error('paralelos_id')
                                        <small style="color:red">{{ $message }}</small>
                                    @enderror
                               ...
                               <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" value="{{ $matriculacion->fecha_matriculacion }}" disabled>
                                    </div>
