...
@section('content_header')
    <h1 style="font-weight: bold; font-size: 1.5rem">Listado de Padres de Familia </h1>
    <hr>
@stop
                ...
                <div class="card card-outline card-purple">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="{{ url('admin/ppffs/create') }}" class="btn btn-primary ">
                                            ...
                                            <div class="row d-flex justify-content-center">
                                                ...
                                                <form action="{{ url('/admin/ppffs/' . $ppff->id) }}" method="post"
                                                    ...
                                                    <button type="submit" class="btn btn-danger btn-sm"
                                                        onclick="event.preventDefault(); eliminarEstudiante('{{ $ppff->id }}');">
