...
@section('content_header')
    <h1 style="font-weight: bold; font-size: 1.5rem">Listado de Materias</h1>
    <hr>
@stop
                                              ...
                                              <div class="row d-flex justify-content-center">
                                                ...
                                                <form action="{{ url('/admin/materias/' . $materia->id) }}" method="post"
                                                    ...
                                                    <button type="submit" style="margin: 3px" class="btn btn-danger btn-sm"
                                                        onclick="event.preventDefault(); eliminarMateria('{{ $materia->id }}');">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{ url('admin/materias/' . $materia->id) }}"
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            <label for="">Nombre de la Materia
                                                                            </label><b>(*)</b>
                                                                            <div class="input-group mb-3">
                                                                                <div class="input-group-prepend">
                                                                                    <span class="input-group-text"><i
