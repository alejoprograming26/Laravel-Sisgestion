...
@section('content_header')
    <h1 style="font-weight: bold; font-size: 1.5rem">Listado de Turnos</h1>
    <hr>
@stop
                ...
                <div class="card card-outline card-purple">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="{{ url('/admin/turnos/create') }}" class="btn btn-primary ">
                                            ...
                                            <div class="row d-flex justify-content-center">
                                                ...
                                                <form action="{{ url('/admin/turnos/' . $turno->id) }}" method="post"
                                                    ...
                                                    <button type="submit" class="btn btn-danger btn-sm"
                                                        onclick="event.preventDefault(); eliminarTurno('{{ $turno->id }}');">
