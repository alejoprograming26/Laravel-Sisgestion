...
@section('content_header')
    <h1 style="font-weight: bold; font-size: 1.5rem">Creacion de un Nuevo Estudiante </h1>
    <hr>
@stop
   ...
   <div class="row">
    <div class="col-md-12">
        <div class="card card-purple card-outline">
            ...
            <div class="card-body" id="padres" style="display: none">
             <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="">Nombres</label><b>(*)</b>
             ...
             <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="">Parentesco</label><b>(*)</b>
                        <p id="parentesco"> aaa</p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="">Ocupacion</label><b>(*)</b>
                        <p id="ocupacion"> aaa</p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
            ...
            <div class="card card-purple">
                ...
                <div class="card-body">
                    <form action="{{ url('/admin/estudiantes/create') }}" method="POST" enctype="multipart/form-data" >
                        @csrf
                        <input type="text" name="ppff_id" id="ppff_id" hidden required>
