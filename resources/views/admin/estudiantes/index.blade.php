...
@section('content_header')
    <h1 style="font-weight: bold; font-size: 1.5rem">Listado de Estudiantes </h1>
    <hr>
@stop
            ...
            <div class="col-md-12">
                <div class="card card-outline card-purple">
                    <div class="card-header">
                        <h3 class="card-title">Estudiantes Registrado</h3>

                        <div class="card-tools">
                            <a href="{{ url('/admin/estudiantes/create/') }}" class="btn btn-primary ">
                                            ...
                                            <div class="row d-flex justify-content-center">
                                                ...
                                                <form action="{{ url('/admin/estudiantes/' . $estudiante->id) }}" method="post"
                                                    ...
                                                    <button type="submit" class="btn btn-danger btn-sm"
                                                        onclick="event.preventDefault(); eliminarEstudiante('{{ $estudiante->id }}');">
